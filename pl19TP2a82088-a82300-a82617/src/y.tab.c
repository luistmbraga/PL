...
static const char *const yytname[] =
{
  ...
  "';'", "','", "$accept", "DicFinance", "Capitulos", "Capitulo", "$@1",
  "Letra", "Traducoes", "Traducao", "Original", "Significado", YY_NULLPTR
};
#endif
